  ...
  runtime_env = merge(
    {
      ...
      KEYCLOAK_BOOTSTRAP_ADMIN_PASSWORD = local.generated_secrets.keycloak_bootstrap_admin_password
      KEYCLOAK_BOOTSTRAP_ADMIN_USERNAME = local.keycloak_bootstrap_admin_username
