...
def build_policies(trusted_hosts: list[str], web_origins: list[str]) -> list[dict]:
    return [
        {
            "name": "Trusted Hosts",
...
def main() -> int:
    ...
    parser.add_argument("--trusted-hosts", required=True, type=json.loads)
    parser.add_argument("--web-origins", required=True, type=json.loads)
    args = parser.parse_args()

    policies = build_policies(args.trusted_hosts, args.web_origins)
